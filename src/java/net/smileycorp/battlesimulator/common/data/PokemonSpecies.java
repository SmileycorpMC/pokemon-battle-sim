...
public class PokemonSpecies {
	...
	public void exportJson(Path folder) throws IOException {
		...
		json.add("canDynamax", new JsonPrimitive(canDynamax));
		json.add("isLegendary", new JsonPrimitive(isLegendary));
		json.add("isMythical", new JsonPrimitive(isMythical));
		json.add("isRestricted", new JsonPrimitive(isRestricted));
		json.add("isBaby", new JsonPrimitive(isBaby));
	...
	public static PokemonSpecies fromJson(String unlocalizedName, JsonObject pokemonJson) {
		...
		pokemon.canDynamax = pokemonJson.get("canDynamax").getAsBoolean();
		pokemon.isLegendary = pokemonJson.get("isLegendary").getAsBoolean();
		pokemon.isMythical = pokemonJson.get("isMythical").getAsBoolean();
		if (pokemonJson.has("isRestricted")) pokemon.isRestricted = pokemonJson.get("isRestricted").getAsBoolean();
		pokemon.isBaby = pokemonJson.get("isBaby").getAsBoolean();
